      ...
      <div className="app-container">
        ...
        <div className="main-content">
          ...
          <main className="genre-grid">
            ...
            <button className="genre-button">Some genre</button>
            <button className="genre-button">Some other genre</button>
            <button className="genre-button">Another genre</button>
            <button className="genre-button">etc</button>
          </main>
        </div>
      </div>
    </>
