      ...
      <div className="main-content">
        ...
        <main className="help-grid">
          ...
          <p className="help-para">
            ...
            have to keep skipping songs that aren't what you're feeling. You can
            set how long the playlist is, what vibe you want or even just put a
            song in and let us do the heavy lifting!{" "}
          </p>
          <p className="help-para">
            The sidebar to your left will let you choose a category to
            complement your vibe, and if you click the button below it will take
            you back to the song input. Happy vibing! 🎶{" "}
          </p>
